...
void smode_trap_handler(void) {
  ...
  if (cause == CAUSE_USER_ECALL) {
    ...
    // if (current->trapframe->regs.a0 == SYS_user_allocate_page) {
    //   sprint("alloc come here\n"); // TODO:remove this line after you finish lab2_2
    // }
    // else if (current->trapframe->regs.a0 == SYS_user_free_page) {
    //   sprint("free come here\n"); // TODO:remove this line after you finish lab2_2
    // }
    // else if (current->trapframe->regs.a0 == SYS_user_print) {
    //   sprint("print come here\n"); // TODO:remove this line after you finish lab2_2
    // }
    // else if (current->trapframe->regs.a0 == SYS_user_exit) {
    //   sprint("exit come here\n"); // TODO:remove this line after you finish lab2_2
    // }
    // else {
    //   sprint("unknown syscall come here\n"); // TODO:remove this line after you finish lab2_2
    // }
